#!/bin/bash
JAVA_HOME=$(update-java-alternatives --jre-headless --list | grep "\\W\(108\|111\|171\|181\|191\|211\|180[0-9][0-9][0-9]\|211[0-9][0-9][0-9]\)[0-9]\\W" | tr -s " " | sort -k2 | tail -1 | cut -d" " -f3)
